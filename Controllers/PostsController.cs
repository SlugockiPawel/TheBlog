...
public sealed class PostsController : Controller
{
    ...
    public async Task<IActionResult> TagIndex(int? page, string tagText)
    {
        ...
        var posts = await _context.Posts
            ...
            .Where(
                p =>
                    p.Tags.Any(t => t.Text.ToLower() == tagText)
    ...
    public async Task<IActionResult> Create(
        [Bind("CategoryId,Title,Abstract,Content,ReadyStatus,Image")]
        Post post,
    ...
    public async Task<IActionResult> Edit(
        int id,
        [Bind("Id,CategoryId,Title,Abstract,Content,ReadyStatus")]
        Post post,
        IFormFile newImage,
        List<string> tagValues
    ) //name of the select list is tagValues => it has to match!
    {
